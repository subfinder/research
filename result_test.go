...
func BenchmarkInitializeSuccessResultSingleThreaded(b *testing.B) {
	for n := 0; n < b.N; n++ {
		_ = Result{Type: "example", Success: n}
	}
}

func BenchmarkInitializeEmptyPointerToResultSingleThreaded(b *testing.B) {
	for n := 0; n < b.N; n++ {
		_ = &Result{}
	}
}
...
func BenchmarkInitializeEmptyResultMulitThreaded(b *testing.B) {
	wg := sync.WaitGroup{}
	for n := 0; n < b.N; n++ {
		wg.Add(1)
		go func() {
...
func BenchmarkInitializeSuccessResultMulitThreaded(b *testing.B) {
	wg := sync.WaitGroup{}
	for n := 0; n < b.N; n++ {
		wg.Add(1)
		go func() {
...
func BenchmarkInitializeEmptyPointerToResultMulitThreaded(b *testing.B) {
	wg := sync.WaitGroup{}
	for n := 0; n < b.N; n++ {
		wg.Add(1)
		go func() {
